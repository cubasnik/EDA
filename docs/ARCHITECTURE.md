...
EDA (Enhanced Dynamic Activation) — это класс платформ динамической активации
...
микросервисов, сгруппированных в функциональные блоки: Inbound
...
Ниже — прямое соответствие между тем, что реализовано здесь, и типовыми
микросервисами такого класса платформ.

| Функциональный блок EDA   | Типовой микросервис               | Что реализовано в этом проекте |
|----------------------------|------------------------------------|----------------------------------|
