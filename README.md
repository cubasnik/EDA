...
Enhanced Dynamic Activation (EDA) — это технология и набор функций в решениях
EricssonSoftware, предназначенные для динамической активации сетевых сервисов,
лицензий или функций без необходимости длительных ручных операций или
перезапуска системы. В разных продуктах EricssonSoftware термин EDA означает
автоматическое включение нужной функциональности по мере необходимости.

В телеком-сетях это позволяет операторам быстрее вводить новые услуги,
масштабировать сеть и адаптироваться к изменению нагрузки.

**Основные идеи EDA:**

- Динамическая активация функций — включение программных возможностей без
  полной переустановки ПО.
- Автоматизация — уменьшение количества ручных действий инженеров.
- Гибкое лицензирование — активация приобретённых функций или ёмкости по
  лицензии.
- Масштабирование — добавление ресурсов при росте нагрузки.
- Минимизация простоев — многие изменения можно выполнять без остановки
  сервисов.

В зависимости от продукта EricssonSoftware EDA может применяться, например, к:

- активации лицензируемых функций;
- управлению сетевыми сервисами в виртуализированных средах (NFV/CNF);
- динамическому выделению вычислительных ресурсов;
- автоматической настройке компонентов сети.

**Где используется**

Концепции динамической активации встречаются в различных решениях
EricssonSoftware, включая:

- LTE/EPC;
- 5G Core;
- OSS/BSS;
- облачную инфраструктуру EricssonSoftware;
- системы управления сетью.

**Преимущества**

- более быстрый ввод новых услуг;
- сокращение операционных затрат;
- повышение гибкости сети;
- более эффективное использование ресурсов;
- снижение времени простоя при изменениях конфигурации.
...
docs/             # архитектурные заметки, таблица соответствий с отраслевыми EDA-платформами, каталог параметров
parameters/       # машиночитаемый каталог параметров (eda_parameters.json)
```
